...
public interface APIAuditLocalService
	...
	public APIAudit updateApiAuditData(
		...
		long requestClassPK, boolean bulkRequest, Date requestTime,
		Date responseTime, long userId);
