 ...
 * <code>bd.gov.dgfood.common.services.service.impl.APIAuditLocalServiceImpl</code> and
...
public class APIAuditLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.common.services.service.impl.APIAuditLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static APIAudit createAPIAudit(long apiAuditId) {
		return getService().createAPIAudit(apiAuditId);
	}
	 ...
	 */
	public static APIAudit deleteAPIAudit(long apiAuditId)
		throws PortalException {

		return getService().deleteAPIAudit(apiAuditId);
	}
	...
	public static APIAudit fetchAPIAudit(long apiAuditId) {
		return getService().fetchAPIAudit(apiAuditId);
	}
	 ...
	 * @throws PortalException if a api audit with the primary key could not be found
	 */
	public static APIAudit getAPIAudit(long apiAuditId) throws PortalException {
		return getService().getAPIAudit(apiAuditId);
	}
	...
	public static APIAudit updateApiAuditData(
		...
		return getService().updateApiAuditData(
