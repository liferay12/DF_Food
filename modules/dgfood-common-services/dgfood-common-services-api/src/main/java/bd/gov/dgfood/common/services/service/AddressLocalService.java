...
public interface AddressLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Address> getAddressListByClassNameAndClassPK(
