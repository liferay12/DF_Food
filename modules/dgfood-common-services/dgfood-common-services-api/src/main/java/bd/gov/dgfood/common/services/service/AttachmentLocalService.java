...
public interface AttachmentLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Attachment> getAttachmentsByClassPKAndClassName(
