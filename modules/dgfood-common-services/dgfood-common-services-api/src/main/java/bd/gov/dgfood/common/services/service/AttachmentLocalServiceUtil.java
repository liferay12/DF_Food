 ...
 * <code>bd.gov.dgfood.common.services.service.impl.AttachmentLocalServiceImpl</code> and
...
public class AttachmentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.common.services.service.impl.AttachmentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static List<Attachment> fetchUserAttachments(
		List<Long> attachmentIds) {

		return getService().fetchUserAttachments(attachmentIds);
	}
	...
	public static List<Attachment> getAttachmentsByClassPKAndClassName(
		long classPK, String className) {

		return getService().getAttachmentsByClassPKAndClassName(
			classPK, className);
	}
	...
	public static Attachment updateAttachment(
			long attachmentId, long fileEntryId, String title,
			Map<String, Serializable> metadata)
		throws PortalException {

		return getService().updateAttachment(
