...
/**
 * Provides the local service interface for DGFUsers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DGFUsersLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DGFUsersLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.common.services.service.impl.DGFUsersLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dgf users local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DGFUsersLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DGFUsers addDGFUsers(DGFUsers dgfUsers);
	...
	public DGFUsers createDGFUsers(long dgfUserId);
	...
	public DGFUsers deleteDGFUsers(DGFUsers dgfUsers);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DGFUsers deleteDGFUsers(long dgfUserId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DGFUsers fetchDGFUsers(long dgfUserId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DGFUsers getDGFUsers(long dgfUserId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DGFUsers> getDGFUserses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DGFUsers updateDGFUsers(DGFUsers dgfUsers);
