 ...
 * <code>bd.gov.dgfood.common.services.service.impl.DGFUsersLocalServiceImpl</code> and
...
public class DGFUsersLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.common.services.service.impl.DGFUsersLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DGFUsers createDGFUsers(long dgfUserId) {
		return getService().createDGFUsers(dgfUserId);
	}
	 ...
	 */
	public static DGFUsers deleteDGFUsers(long dgfUserId)
		throws PortalException {

		return getService().deleteDGFUsers(dgfUserId);
	}
	...
	public static DGFUsers fetchDGFUsers(long dgfUserId) {
		return getService().fetchDGFUsers(dgfUserId);
	}
	 ...
	 * @throws PortalException if a dgf users with the primary key could not be found
	 */
	public static DGFUsers getDGFUsers(long dgfUserId) throws PortalException {
		return getService().getDGFUsers(dgfUserId);
	}
