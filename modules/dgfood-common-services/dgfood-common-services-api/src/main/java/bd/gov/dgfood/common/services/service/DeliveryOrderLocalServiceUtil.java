...
/**
 * Provides the local service utility for DeliveryOrder. This utility wraps
 * <code>bd.gov.dgfood.common.services.service.impl.DeliveryOrderLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DeliveryOrderLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.common.services.service.impl.DeliveryOrderLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DeliveryOrder addDeliveryOrder(DeliveryOrder deliveryOrder) {
		return getService().addDeliveryOrder(deliveryOrder);
	}
	...
	public static DeliveryOrder createDeliveryOrder(
		...
		return getService().createDeliveryOrder(deliveryOrderPK);
	}
	 ...
	 */
	public static DeliveryOrder deleteDeliveryOrder(
		DeliveryOrder deliveryOrder) {

		return getService().deleteDeliveryOrder(deliveryOrder);
	}
	...
	public static DeliveryOrder deleteDeliveryOrder(
		...
		return getService().deleteDeliveryOrder(deliveryOrderPK);
	}
	...
	public static DeliveryOrder fetchDeliveryOrder(
		bd.gov.dgfood.common.services.service.persistence.DeliveryOrderPK
			deliveryOrderPK) {

		return getService().fetchDeliveryOrder(deliveryOrderPK);
	}
	 ...
	 */
	public static DeliveryOrder fetchDeliveryOrderByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().fetchDeliveryOrderByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public static DeliveryOrder getDeliveryOrder(
		...
		return getService().getDeliveryOrder(deliveryOrderPK);
	}
	 ...
	 */
	public static DeliveryOrder getDeliveryOrderByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException {

		return getService().getDeliveryOrderByUuidAndCompanyId(uuid, companyId);
	}
	 ...
	 */
	public static List<DeliveryOrder> getDeliveryOrders(int start, int end) {
		return getService().getDeliveryOrders(start, end);
	}
	 ...
	 */
	public static int getDeliveryOrdersCount() {
		return getService().getDeliveryOrdersCount();
	}
	 ...
	 */
	public static DeliveryOrder updateDeliveryOrder(
		DeliveryOrder deliveryOrder) {

		return getService().updateDeliveryOrder(deliveryOrder);
	}

	public static DeliveryOrderLocalService getService() {
		return _service;
	}

	private static volatile DeliveryOrderLocalService _service;
