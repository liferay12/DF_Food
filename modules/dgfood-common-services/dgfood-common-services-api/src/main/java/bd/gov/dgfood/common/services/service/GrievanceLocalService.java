...
/**
 * Provides the local service interface for Grievance. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see GrievanceLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GrievanceLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.common.services.service.impl.GrievanceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the grievance local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link GrievanceLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Grievance addGrievance(
		ServiceContext serviceContext, long grievanceCategory, String userName,
		long userType, String mobileNumber, String complaintDetails,
		long attachmentId);
	...
	public void replyGrievance(
		ThemeDisplay themeDisplay, long grievanceId, String responseDetails);
