...
/**
 * Provides the local service interface for Indent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see IndentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface IndentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.common.services.service.impl.IndentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the indent local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link IndentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Indent addIndent(
			...
			String quantityUnit, Date requiredDeliveryDate,
