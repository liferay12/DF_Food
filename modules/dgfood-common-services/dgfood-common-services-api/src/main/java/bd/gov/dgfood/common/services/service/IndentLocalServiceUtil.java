...
/**
 * Provides the local service utility for Indent. This utility wraps
 * <code>bd.gov.dgfood.common.services.service.impl.IndentLocalServiceImpl</code> and
 ...
 * @generated
 */
public class IndentLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.common.services.service.impl.IndentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Indent addIndent(Indent indent) {
		return getService().addIndent(indent);
	}

	public static Indent addIndent(
	 ...
	 */
	public static Indent createIndent(long indentId) {
		return getService().createIndent(indentId);
	}
	 ...
	 */
	public static Indent deleteIndent(Indent indent) {
		return getService().deleteIndent(indent);
	}
	 ...
	 */
	public static Indent deleteIndent(long indentId) throws PortalException {
		return getService().deleteIndent(indentId);
	}
	...
	public static Indent fetchIndent(long indentId) {
		return getService().fetchIndent(indentId);
	}
	 ...
	 */
	public static Indent fetchIndentByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchIndentByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 * @throws PortalException if a indent with the primary key could not be found
	 */
	public static Indent getIndent(long indentId) throws PortalException {
		return getService().getIndent(indentId);
	}
	 ...
	 */
	public static Indent getIndentByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {

		return getService().getIndentByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<Indent> getIndents(int start, int end) {
		return getService().getIndents(start, end);
	}

	public static List<Indent> getIndents(
		long allocationId, int start, int end) {

		return getService().getIndents(allocationId, start, end);
	}
	 ...
	 */
	public static List<Indent> getIndentsByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getIndentsByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<Indent> getIndentsByUuidAndCompanyId(
		...
		return getService().getIndentsByUuidAndCompanyId(
	 ...
	 */
	public static int getIndentsCount() {
		return getService().getIndentsCount();
	}

	public static int getIndentsCount(long allocationId) {
		return getService().getIndentsCount(allocationId);
	}
	 ...
	 */
	public static Indent updateIndent(Indent indent) {
		return getService().updateIndent(indent);
	}

	public static IndentLocalService getService() {
		return _service;
	}

	private static volatile IndentLocalService _service;
