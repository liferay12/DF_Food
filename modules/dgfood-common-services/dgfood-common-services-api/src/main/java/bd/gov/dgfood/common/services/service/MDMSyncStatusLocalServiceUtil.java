...
/**
 * Provides the local service utility for MDMSyncStatus. This utility wraps
 * <code>bd.gov.dgfood.common.services.service.impl.MDMSyncStatusLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MDMSyncStatusLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.common.services.service.impl.MDMSyncStatusLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MDMSyncStatus addMDMSyncStatus(MDMSyncStatus mdmSyncStatus) {
		return getService().addMDMSyncStatus(mdmSyncStatus);
	}
	 ...
	 */
	public static MDMSyncStatus createMDMSyncStatus(long mdmSyncStatusId) {
		return getService().createMDMSyncStatus(mdmSyncStatusId);
	}
	 ...
	 */
	public static MDMSyncStatus deleteMDMSyncStatus(long mdmSyncStatusId)
		throws PortalException {

		return getService().deleteMDMSyncStatus(mdmSyncStatusId);
	}
	 ...
	 * @return the mdm sync status that was removed
	 */
	public static MDMSyncStatus deleteMDMSyncStatus(
		MDMSyncStatus mdmSyncStatus) {

		return getService().deleteMDMSyncStatus(mdmSyncStatus);
	}
	...
	public static MDMSyncStatus fetchMDMSyncStatus(long mdmSyncStatusId) {
		return getService().fetchMDMSyncStatus(mdmSyncStatusId);
	}
	 ...
	 * @throws PortalException if a mdm sync status with the primary key could not be found
	 */
	public static MDMSyncStatus getMDMSyncStatus(long mdmSyncStatusId)
		throws PortalException {

		return getService().getMDMSyncStatus(mdmSyncStatusId);
	}
	 ...
	 */
	public static List<MDMSyncStatus> getMDMSyncStatuses(int start, int end) {
		return getService().getMDMSyncStatuses(start, end);
	}
	 ...
	 */
	public static int getMDMSyncStatusesCount() {
		return getService().getMDMSyncStatusesCount();
	}
	 ...
	 */
	public static MDMSyncStatus updateMDMSyncStatus(
		MDMSyncStatus mdmSyncStatus) {

		return getService().updateMDMSyncStatus(mdmSyncStatus);
	}

	public static MDMSyncStatusLocalService getService() {
		return _service;
	}

	private static volatile MDMSyncStatusLocalService _service;
