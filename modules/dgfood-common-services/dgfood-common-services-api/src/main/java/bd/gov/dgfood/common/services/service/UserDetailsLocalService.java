...
/**
 * Provides the local service interface for UserDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserDetailsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.common.services.service.impl.UserDetailsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user details local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserDetailsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public UserDetails createUserDetails(long userDetailsId);
	...
	public UserDetails deleteUserDetails(long userDetailsId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserDetails fetchUserDetails(long userDetailsId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserDetails getUserDetails(long userDetailsId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserDetails> getUserDetailses(int start, int end);
