...
/**
 * Provides the local service utility for UserDetails. This utility wraps
 * <code>bd.gov.dgfood.common.services.service.impl.UserDetailsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class UserDetailsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.common.services.service.impl.UserDetailsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static UserDetails addUserDetails(UserDetails userDetails) {
		return getService().addUserDetails(userDetails);
	}
	 ...
	 */
	public static UserDetails createUserDetails(long userDetailsId) {
		return getService().createUserDetails(userDetailsId);
	}
	 ...
	 */
	public static UserDetails deleteUserDetails(long userDetailsId)
		throws PortalException {

		return getService().deleteUserDetails(userDetailsId);
	}
	 ...
	 * @return the user details that was removed
	 */
	public static UserDetails deleteUserDetails(UserDetails userDetails) {
		return getService().deleteUserDetails(userDetails);
	}
	...
	public static UserDetails fetchUserDetails(long userDetailsId) {
		return getService().fetchUserDetails(userDetailsId);
	}

	public static UserDetails findByNationalId(String nationalId) {
		return getService().findByNationalId(nationalId);
	}
	 ...
	 * @throws PortalException if a user details with the primary key could not be found
	 */
	public static UserDetails getUserDetails(long userDetailsId)
		throws PortalException {

		return getService().getUserDetails(userDetailsId);
	}
	 ...
	 */
	public static List<UserDetails> getUserDetailses(int start, int end) {
		return getService().getUserDetailses(start, end);
	}
	 ...
	 */
	public static int getUserDetailsesCount() {
		return getService().getUserDetailsesCount();
	}
	...
	public static UserDetails updateUserDetails(UserDetails userDetails) {
		return getService().updateUserDetails(userDetails);
	}

	public static UserDetailsLocalService getService() {
		return _service;
	}

	private static volatile UserDetailsLocalService _service;
