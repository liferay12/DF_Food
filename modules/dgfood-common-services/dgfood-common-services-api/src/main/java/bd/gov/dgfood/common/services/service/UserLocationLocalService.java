...
/**
 * Provides the local service interface for UserLocation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserLocationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserLocationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.common.services.service.impl.UserLocationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user location local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserLocationLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserLocation getUserLocationByRK_LC(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserLocation> getUserLocationsByUserId(
