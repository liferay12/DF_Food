 ...
 * @see DeliveryOrderPersistence
 * @generated
 */
public class DeliveryOrderUtil {
	 ...
	 */
	public static void clearCache(DeliveryOrder deliveryOrder) {
		getPersistence().clearCache(deliveryOrder);
	}
	 ...
	 */
	public static Map<Serializable, DeliveryOrder> fetchByPrimaryKeys(
	 ...
	 */
	public static List<DeliveryOrder> findWithDynamicQuery(
	 ...
	 */
	public static DeliveryOrder update(DeliveryOrder deliveryOrder) {
		return getPersistence().update(deliveryOrder);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static DeliveryOrder update(
		DeliveryOrder deliveryOrder, ServiceContext serviceContext) {

		return getPersistence().update(deliveryOrder, serviceContext);
	}
	 ...
	 */
	public static List<DeliveryOrder> findByUuid(String uuid) {
	 ...
	 */
	public static List<DeliveryOrder> findByUuid(
	 ...
	 */
	public static DeliveryOrder fetchByUuid_First(
		String uuid, OrderByComparator<DeliveryOrder> orderByComparator) {
	 ...
	 * @throws NoSuchDeliveryOrderException if a matching delivery order could not be found
	 */
	public static DeliveryOrder findByUuid_Last(
			String uuid, OrderByComparator<DeliveryOrder> orderByComparator)
		throws bd.gov.dgfood.common.services.exception.
			NoSuchDeliveryOrderException {
	 ...
	 */
	public static DeliveryOrder fetchByUuid_Last(
		String uuid, OrderByComparator<DeliveryOrder> orderByComparator) {
	 ...
	 */
	public static DeliveryOrder[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			deliveryOrderPK, uuid, orderByComparator);
	}
	 ...
	 * @return the matching delivery orders
	 */
	public static List<DeliveryOrder> findByUuid_C(
	 ...
	 * @throws NoSuchDeliveryOrderException if a matching delivery order could not be found
	 */
	public static DeliveryOrder findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<DeliveryOrder> orderByComparator)
		throws bd.gov.dgfood.common.services.exception.
			NoSuchDeliveryOrderException {
	 ...
	 * @return the first matching delivery order, or <code>null</code> if a matching delivery order could not be found
	 */
	public static DeliveryOrder fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<DeliveryOrder> orderByComparator) {
	 ...
	 * @throws NoSuchDeliveryOrderException if a matching delivery order could not be found
	 */
	public static DeliveryOrder findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<DeliveryOrder> orderByComparator)
		throws bd.gov.dgfood.common.services.exception.
			NoSuchDeliveryOrderException {
	 ...
	 * @return the last matching delivery order, or <code>null</code> if a matching delivery order could not be found
	 */
	public static DeliveryOrder fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<DeliveryOrder> orderByComparator) {
	 ...
	 * @throws NoSuchDeliveryOrderException if a delivery order with the primary key could not be found
	 */
	public static DeliveryOrder[] findByUuid_C_PrevAndNext(
			bd.gov.dgfood.common.services.service.persistence.DeliveryOrderPK
				deliveryOrderPK,
			String uuid, long companyId,
			OrderByComparator<DeliveryOrder> orderByComparator)
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			deliveryOrderPK, uuid, companyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(DeliveryOrder deliveryOrder) {
		getPersistence().cacheResult(deliveryOrder);
	}
	 ...
	 */
	public static void cacheResult(List<DeliveryOrder> deliveryOrders) {
		getPersistence().cacheResult(deliveryOrders);
	}
	...
	public static DeliveryOrder create(
		...
		return getPersistence().create(deliveryOrderPK);
	}
	 ...
	 * @throws NoSuchDeliveryOrderException if a delivery order with the primary key could not be found
	 */
	public static DeliveryOrder remove(
			bd.gov.dgfood.common.services.service.persistence.DeliveryOrderPK
				deliveryOrderPK)
		throws bd.gov.dgfood.common.services.exception.
			NoSuchDeliveryOrderException {

		return getPersistence().remove(deliveryOrderPK);
	}

	public static DeliveryOrder updateImpl(DeliveryOrder deliveryOrder) {
		return getPersistence().updateImpl(deliveryOrder);
	}
	 ...
	 * @throws NoSuchDeliveryOrderException if a delivery order with the primary key could not be found
	 */
	public static DeliveryOrder findByPrimaryKey(
			bd.gov.dgfood.common.services.service.persistence.DeliveryOrderPK
				deliveryOrderPK)
		throws bd.gov.dgfood.common.services.exception.
			NoSuchDeliveryOrderException {

		return getPersistence().findByPrimaryKey(deliveryOrderPK);
	}
	 ...
	 */
	public static DeliveryOrder fetchByPrimaryKey(
		bd.gov.dgfood.common.services.service.persistence.DeliveryOrderPK
			deliveryOrderPK) {

		return getPersistence().fetchByPrimaryKey(deliveryOrderPK);
	}
	 ...
	 */
	public static List<DeliveryOrder> findAll(int start, int end) {
	...
	public static DeliveryOrderPersistence getPersistence() {
		return _persistence;
	}

	private static volatile DeliveryOrderPersistence _persistence;
