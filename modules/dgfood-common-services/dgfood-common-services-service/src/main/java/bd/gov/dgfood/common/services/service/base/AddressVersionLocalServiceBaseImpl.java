...
/**
 * Provides the base implementation for the address version local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.AddressVersionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.AddressVersionLocalServiceImpl
 * @generated
 */
public abstract class AddressVersionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddressVersionLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddressVersionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AddressVersionLocalServiceUtil</code>.
	 */
	...
	public AddressVersion createAddressVersion(long addressVersionId) {
		return addressVersionPersistence.create(addressVersionId);
	}
	...
	public AddressVersion deleteAddressVersion(long addressVersionId)
		...
		return addressVersionPersistence.remove(addressVersionId);
	}
	...
	public AddressVersion deleteAddressVersion(AddressVersion addressVersion) {
		return addressVersionPersistence.remove(addressVersion);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addressVersionPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddressVersion.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addressVersionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return addressVersionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addressVersionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return addressVersionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AddressVersion fetchAddressVersion(long addressVersionId) {
		return addressVersionPersistence.fetchByPrimaryKey(addressVersionId);
	}
	...
	public AddressVersion getAddressVersion(long addressVersionId)
		...
		return addressVersionPersistence.findByPrimaryKey(addressVersionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(addressVersionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddressVersion.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("addressVersionId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AddressVersion.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addressVersionPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return addressVersionLocalService.deleteAddressVersion(
			(AddressVersion)persistedModel);
	}

	@Override
	public BasePersistence<AddressVersion> getBasePersistence() {
		return addressVersionPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addressVersionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AddressVersion> getAddressVersions(int start, int end) {
		return addressVersionPersistence.findAll(start, end);
	}
	...
	public int getAddressVersionsCount() {
		return addressVersionPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddressVersionLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		addressVersionLocalService = (AddressVersionLocalService)aopProxy;

		_setLocalServiceUtilService(addressVersionLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddressVersionLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = AddressVersionLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, addressVersionLocalService);
		}
