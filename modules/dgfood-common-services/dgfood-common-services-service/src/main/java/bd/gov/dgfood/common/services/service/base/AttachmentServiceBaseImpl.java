...
import bd.gov.dgfood.common.services.service.AttachmentService;
import bd.gov.dgfood.common.services.service.AttachmentServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.AttachmentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.AttachmentServiceImpl
 * @generated
 */
public abstract class AttachmentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AttachmentService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttachmentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AttachmentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttachmentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		attachmentService = (AttachmentService)aopProxy;

		_setServiceUtilService(attachmentService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttachmentService.class.getName();
	}
	...
	private void _setServiceUtilService(AttachmentService attachmentService) {
		try {
			Field field = AttachmentServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, attachmentService);
		}
	...
	@Reference
	protected bd.gov.dgfood.common.services.service.AttachmentLocalService
