...
/**
 * Provides the base implementation for the attachment version local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.AttachmentVersionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.AttachmentVersionLocalServiceImpl
 * @generated
 */
public abstract class AttachmentVersionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AttachmentVersionLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttachmentVersionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AttachmentVersionLocalServiceUtil</code>.
	 */
	...
	public AttachmentVersion createAttachmentVersion(long attachmentVersionId) {
		return attachmentVersionPersistence.create(attachmentVersionId);
	}
	...
	public AttachmentVersion deleteAttachmentVersion(long attachmentVersionId)
		...
		return attachmentVersionPersistence.remove(attachmentVersionId);
	}
	...
	public AttachmentVersion deleteAttachmentVersion(
		...
		return attachmentVersionPersistence.remove(attachmentVersion);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return attachmentVersionPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AttachmentVersion.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return attachmentVersionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return attachmentVersionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return attachmentVersionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return attachmentVersionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AttachmentVersion fetchAttachmentVersion(long attachmentVersionId) {
		return attachmentVersionPersistence.fetchByPrimaryKey(
			attachmentVersionId);
	}
	...
	public AttachmentVersion getAttachmentVersion(long attachmentVersionId)
		...
		return attachmentVersionPersistence.findByPrimaryKey(
			attachmentVersionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			attachmentVersionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AttachmentVersion.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("attachmentVersionId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AttachmentVersion.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return attachmentVersionPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return attachmentVersionLocalService.deleteAttachmentVersion(
			(AttachmentVersion)persistedModel);
	}

	@Override
	public BasePersistence<AttachmentVersion> getBasePersistence() {
		return attachmentVersionPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return attachmentVersionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AttachmentVersion> getAttachmentVersions(int start, int end) {
		return attachmentVersionPersistence.findAll(start, end);
	}
	...
	public int getAttachmentVersionsCount() {
		return attachmentVersionPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttachmentVersionLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		attachmentVersionLocalService = (AttachmentVersionLocalService)aopProxy;

		_setLocalServiceUtilService(attachmentVersionLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttachmentVersionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				attachmentVersionPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				AttachmentVersionLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, attachmentVersionLocalService);
		}
