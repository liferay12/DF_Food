...
import bd.gov.dgfood.common.services.service.AttachmentVersionService;
import bd.gov.dgfood.common.services.service.AttachmentVersionServiceUtil;
...
/**
 * Provides the base implementation for the attachment version remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.AttachmentVersionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.AttachmentVersionServiceImpl
 * @generated
 */
public abstract class AttachmentVersionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AttachmentVersionService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttachmentVersionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AttachmentVersionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttachmentVersionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		attachmentVersionService = (AttachmentVersionService)aopProxy;

		_setServiceUtilService(attachmentVersionService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttachmentVersionService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = AttachmentVersionServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, attachmentVersionService);
		}
	...
	@Reference
	protected
		bd.gov.dgfood.common.services.service.AttachmentVersionLocalService
			attachmentVersionLocalService;

	protected AttachmentVersionService attachmentVersionService;
