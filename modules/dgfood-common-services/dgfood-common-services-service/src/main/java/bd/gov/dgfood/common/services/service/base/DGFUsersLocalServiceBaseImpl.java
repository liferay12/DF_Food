...
import bd.gov.dgfood.common.services.service.DGFUsersLocalService;
import bd.gov.dgfood.common.services.service.DGFUsersLocalServiceUtil;
...
/**
 * Provides the base implementation for the dgf users local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.DGFUsersLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.DGFUsersLocalServiceImpl
 * @generated
 */
public abstract class DGFUsersLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DGFUsersLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DGFUsersLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DGFUsersLocalServiceUtil</code>.
	 */
	...
	public DGFUsers addDGFUsers(DGFUsers dgfUsers) {
		...
		return dgfUsersPersistence.update(dgfUsers);
	}
	...
	public DGFUsers createDGFUsers(long dgfUserId) {
		return dgfUsersPersistence.create(dgfUserId);
	}
	...
	public DGFUsers deleteDGFUsers(long dgfUserId) throws PortalException {
		return dgfUsersPersistence.remove(dgfUserId);
	}
	...
	public DGFUsers deleteDGFUsers(DGFUsers dgfUsers) {
		return dgfUsersPersistence.remove(dgfUsers);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dgfUsersPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DGFUsers.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dgfUsersPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dgfUsersPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dgfUsersPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return dgfUsersPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DGFUsers fetchDGFUsers(long dgfUserId) {
		return dgfUsersPersistence.fetchByPrimaryKey(dgfUserId);
	}
	...
	public DGFUsers getDGFUsers(long dgfUserId) throws PortalException {
		return dgfUsersPersistence.findByPrimaryKey(dgfUserId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dgfUsersLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DGFUsers.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("dgfUserId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			dgfUsersLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DGFUsers.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("dgfUserId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dgfUsersPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return dgfUsersLocalService.deleteDGFUsers((DGFUsers)persistedModel);
	}

	@Override
	public BasePersistence<DGFUsers> getBasePersistence() {
		return dgfUsersPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dgfUsersPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DGFUsers> getDGFUserses(int start, int end) {
		return dgfUsersPersistence.findAll(start, end);
	}
	...
	public int getDGFUsersesCount() {
		return dgfUsersPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DGFUsersLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dgfUsersLocalService = (DGFUsersLocalService)aopProxy;

		_setLocalServiceUtilService(dgfUsersLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DGFUsersLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dgfUsersPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DGFUsersLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfUsersLocalService);
		}
	...
	protected DGFUsersLocalService dgfUsersLocalService;
