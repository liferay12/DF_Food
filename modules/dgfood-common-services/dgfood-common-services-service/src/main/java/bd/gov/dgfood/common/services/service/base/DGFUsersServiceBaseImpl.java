...
import bd.gov.dgfood.common.services.service.DGFUsersService;
import bd.gov.dgfood.common.services.service.DGFUsersServiceUtil;
...
/**
 * Provides the base implementation for the dgf users remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.DGFUsersServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.DGFUsersServiceImpl
 * @generated
 */
public abstract class DGFUsersServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DGFUsersService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DGFUsersService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DGFUsersServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DGFUsersService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfUsersService = (DGFUsersService)aopProxy;

		_setServiceUtilService(dgfUsersService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DGFUsersService.class.getName();
	}
	...
	private void _setServiceUtilService(DGFUsersService dgfUsersService) {
		try {
			Field field = DGFUsersServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfUsersService);
		}
	...
	@Reference
	protected bd.gov.dgfood.common.services.service.DGFUsersLocalService
		dgfUsersLocalService;

	protected DGFUsersService dgfUsersService;
