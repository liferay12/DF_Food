...
import bd.gov.dgfood.common.services.service.DeliveryOrderService;
import bd.gov.dgfood.common.services.service.DeliveryOrderServiceUtil;
...
/**
 * Provides the base implementation for the delivery order remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.DeliveryOrderServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.DeliveryOrderServiceImpl
 * @generated
 */
public abstract class DeliveryOrderServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DeliveryOrderService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DeliveryOrderService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DeliveryOrderServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DeliveryOrderService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		deliveryOrderService = (DeliveryOrderService)aopProxy;

		_setServiceUtilService(deliveryOrderService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DeliveryOrderService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DeliveryOrderServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, deliveryOrderService);
		}
	...
	@Reference
	protected bd.gov.dgfood.common.services.service.DeliveryOrderLocalService
