...
import bd.gov.dgfood.common.services.service.GrievanceService;
import bd.gov.dgfood.common.services.service.GrievanceServiceUtil;
...
/**
 * Provides the base implementation for the grievance remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.GrievanceServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.GrievanceServiceImpl
 * @generated
 */
public abstract class GrievanceServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GrievanceService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GrievanceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>GrievanceServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GrievanceService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		grievanceService = (GrievanceService)aopProxy;

		_setServiceUtilService(grievanceService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return GrievanceService.class.getName();
	}
	...
	private void _setServiceUtilService(GrievanceService grievanceService) {
		try {
			Field field = GrievanceServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, grievanceService);
		}
	...
	@Reference
	protected bd.gov.dgfood.common.services.service.GrievanceLocalService
