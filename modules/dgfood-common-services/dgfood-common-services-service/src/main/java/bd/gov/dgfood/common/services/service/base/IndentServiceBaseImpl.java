...
import bd.gov.dgfood.common.services.service.IndentService;
import bd.gov.dgfood.common.services.service.IndentServiceUtil;
...
/**
 * Provides the base implementation for the indent remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.IndentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.IndentServiceImpl
 * @generated
 */
public abstract class IndentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, IndentService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>IndentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>IndentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			IndentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		indentService = (IndentService)aopProxy;

		_setServiceUtilService(indentService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return IndentService.class.getName();
	}
	...
	private void _setServiceUtilService(IndentService indentService) {
		try {
			Field field = IndentServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, indentService);
		}
	...
	@Reference
	protected bd.gov.dgfood.common.services.service.IndentLocalService
		indentLocalService;
