...
import bd.gov.dgfood.common.services.service.MDMSyncStatusLocalService;
...
/**
 * Provides the base implementation for the mdm sync status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.MDMSyncStatusLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.MDMSyncStatusLocalServiceImpl
 * @generated
 */
public abstract class MDMSyncStatusLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MDMSyncStatusLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MDMSyncStatusLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MDMSyncStatusLocalServiceUtil</code>.
	 */
	...
	public MDMSyncStatus addMDMSyncStatus(MDMSyncStatus mdmSyncStatus) {
		...
		return mdmSyncStatusPersistence.update(mdmSyncStatus);
	}
	...
	public MDMSyncStatus createMDMSyncStatus(long mdmSyncStatusId) {
		return mdmSyncStatusPersistence.create(mdmSyncStatusId);
	}
	...
	public MDMSyncStatus deleteMDMSyncStatus(long mdmSyncStatusId)
		...
		return mdmSyncStatusPersistence.remove(mdmSyncStatusId);
	}
	...
	public MDMSyncStatus deleteMDMSyncStatus(MDMSyncStatus mdmSyncStatus) {
		return mdmSyncStatusPersistence.remove(mdmSyncStatus);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return mdmSyncStatusPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MDMSyncStatus.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return mdmSyncStatusPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return mdmSyncStatusPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return mdmSyncStatusPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return mdmSyncStatusPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MDMSyncStatus fetchMDMSyncStatus(long mdmSyncStatusId) {
		return mdmSyncStatusPersistence.fetchByPrimaryKey(mdmSyncStatusId);
	}
	...
	public MDMSyncStatus getMDMSyncStatus(long mdmSyncStatusId)
		...
		return mdmSyncStatusPersistence.findByPrimaryKey(mdmSyncStatusId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(mdmSyncStatusLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MDMSyncStatus.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("mdmSyncStatusId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			mdmSyncStatusLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MDMSyncStatus.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return mdmSyncStatusPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return mdmSyncStatusLocalService.deleteMDMSyncStatus(
			(MDMSyncStatus)persistedModel);
	}

	@Override
	public BasePersistence<MDMSyncStatus> getBasePersistence() {
		return mdmSyncStatusPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return mdmSyncStatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MDMSyncStatus> getMDMSyncStatuses(int start, int end) {
		return mdmSyncStatusPersistence.findAll(start, end);
	}
	...
	public int getMDMSyncStatusesCount() {
		return mdmSyncStatusPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MDMSyncStatusLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		mdmSyncStatusLocalService = (MDMSyncStatusLocalService)aopProxy;

		_setLocalServiceUtilService(mdmSyncStatusLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MDMSyncStatusLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = mdmSyncStatusPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = MDMSyncStatusLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, mdmSyncStatusLocalService);
		}
	...
	protected MDMSyncStatusLocalService mdmSyncStatusLocalService;
