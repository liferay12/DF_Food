...
import bd.gov.dgfood.common.services.service.MDMSyncStatusService;
import bd.gov.dgfood.common.services.service.MDMSyncStatusServiceUtil;
...
/**
 * Provides the base implementation for the mdm sync status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.MDMSyncStatusServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.MDMSyncStatusServiceImpl
 * @generated
 */
public abstract class MDMSyncStatusServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MDMSyncStatusService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MDMSyncStatusService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MDMSyncStatusServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MDMSyncStatusService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		mdmSyncStatusService = (MDMSyncStatusService)aopProxy;

		_setServiceUtilService(mdmSyncStatusService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MDMSyncStatusService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = MDMSyncStatusServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, mdmSyncStatusService);
		}
	...
	@Reference
	protected bd.gov.dgfood.common.services.service.MDMSyncStatusLocalService
		mdmSyncStatusLocalService;

	protected MDMSyncStatusService mdmSyncStatusService;
