...
import bd.gov.dgfood.common.services.service.UserDetailsLocalService;
...
/**
 * Provides the base implementation for the user details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.UserDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.UserDetailsLocalServiceImpl
 * @generated
 */
public abstract class UserDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, UserDetailsLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UserDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>UserDetailsLocalServiceUtil</code>.
	 */
	...
	public UserDetails addUserDetails(UserDetails userDetails) {
		...
		return userDetailsPersistence.update(userDetails);
	}
	...
	public UserDetails createUserDetails(long userDetailsId) {
		return userDetailsPersistence.create(userDetailsId);
	}
	...
	public UserDetails deleteUserDetails(long userDetailsId)
		...
		return userDetailsPersistence.remove(userDetailsId);
	}
	...
	public UserDetails deleteUserDetails(UserDetails userDetails) {
		return userDetailsPersistence.remove(userDetails);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return userDetailsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			UserDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return userDetailsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return userDetailsPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public UserDetails fetchUserDetails(long userDetailsId) {
		return userDetailsPersistence.fetchByPrimaryKey(userDetailsId);
	}
	...
	public UserDetails getUserDetails(long userDetailsId)
		...
		return userDetailsPersistence.findByPrimaryKey(userDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(userDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(UserDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("userDetailsId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(UserDetails.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return userDetailsPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return userDetailsLocalService.deleteUserDetails(
			(UserDetails)persistedModel);
	}

	@Override
	public BasePersistence<UserDetails> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return userDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<UserDetails> getUserDetailses(int start, int end) {
		return userDetailsPersistence.findAll(start, end);
	}
	...
	public int getUserDetailsesCount() {
		return userDetailsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UserDetailsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		userDetailsLocalService = (UserDetailsLocalService)aopProxy;

		_setLocalServiceUtilService(userDetailsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return UserDetailsLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = UserDetailsLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, userDetailsLocalService);
		}
