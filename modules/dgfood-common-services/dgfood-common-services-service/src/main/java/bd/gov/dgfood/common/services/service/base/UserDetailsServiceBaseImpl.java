...
import bd.gov.dgfood.common.services.service.UserDetailsService;
import bd.gov.dgfood.common.services.service.UserDetailsServiceUtil;
...
/**
 * Provides the base implementation for the user details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.UserDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.UserDetailsServiceImpl
 * @generated
 */
public abstract class UserDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, UserDetailsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UserDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>UserDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UserDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		userDetailsService = (UserDetailsService)aopProxy;

		_setServiceUtilService(userDetailsService);
	}
	...
	private void _setServiceUtilService(UserDetailsService userDetailsService) {
		try {
			Field field = UserDetailsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, userDetailsService);
		}
	...
	@Reference
	protected bd.gov.dgfood.common.services.service.UserDetailsLocalService
