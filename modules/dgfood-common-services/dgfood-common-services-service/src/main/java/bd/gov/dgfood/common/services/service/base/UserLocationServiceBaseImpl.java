...
/**
 * Provides the base implementation for the user location remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.common.services.service.impl.UserLocationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.common.services.service.impl.UserLocationServiceImpl
 * @generated
 */
public abstract class UserLocationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, UserLocationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UserLocationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>UserLocationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UserLocationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		userLocationService = (UserLocationService)aopProxy;

		_setServiceUtilService(userLocationService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return UserLocationService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = UserLocationServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, userLocationService);
		}
	...
	@Reference
	protected bd.gov.dgfood.common.services.service.UserLocationLocalService
