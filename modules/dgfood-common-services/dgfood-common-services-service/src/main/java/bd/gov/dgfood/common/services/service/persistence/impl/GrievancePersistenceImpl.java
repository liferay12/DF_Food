...
import bd.gov.dgfood.common.services.model.GrievanceTable;
import bd.gov.dgfood.common.services.model.impl.GrievanceImpl;
import bd.gov.dgfood.common.services.model.impl.GrievanceModelImpl;
import bd.gov.dgfood.common.services.service.persistence.GrievancePersistence;
import bd.gov.dgfood.common.services.service.persistence.GrievanceUtil;
 ...
 * @generated
 */
@Component(service = {GrievancePersistence.class, BasePersistence.class})
public class GrievancePersistenceImpl
	 ...
	 */
	@Override
	public List<Grievance> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<Grievance> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<Grievance> findByUuid(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Grievance grievance : list) {
					if (!uuid.equals(grievance.getUuid())) {
						list = null;
	...
	public Grievance findByUuid_First(
		...
		Grievance grievance = fetchByUuid_First(uuid, orderByComparator);
	...
	public Grievance fetchByUuid_First(
		...
		List<Grievance> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public Grievance findByUuid_Last(
		...
		Grievance grievance = fetchByUuid_Last(uuid, orderByComparator);
	...
	public Grievance fetchByUuid_Last(
		...
		List<Grievance> list = findByUuid(
	...
	public Grievance[] findByUuid_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, grievance, uuid, orderByComparator, true);

			array[1] = grievance;

			array[2] = getByUuid_PrevAndNext(
				session, grievance, uuid, orderByComparator, false);
	...
	protected Grievance getByUuid_PrevAndNext(
		Session session, Grievance grievance, String uuid,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(grievance.uuid IS NULL OR grievance.uuid = '')";
	...
	public Grievance findByUUID_G(String uuid, long groupId)
		...
		Grievance grievance = fetchByUUID_G(uuid, groupId);
	...
	public Grievance fetchByUUID_G(
		...
		if (result instanceof Grievance) {
			Grievance grievance = (Grievance)result;

			if (!Objects.equals(uuid, grievance.getUuid()) ||
				(groupId != grievance.getGroupId())) {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					Grievance grievance = list.get(0);
	...
	public Grievance removeByUUID_G(String uuid, long groupId)
		...
		Grievance grievance = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(grievance.uuid IS NULL OR grievance.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<Grievance> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<Grievance> findByUuid_C(
	...
	public List<Grievance> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Grievance grievance : list) {
					if (!uuid.equals(grievance.getUuid()) ||
						(companyId != grievance.getCompanyId())) {
	...
	public Grievance findByUuid_C_First(
		...
		Grievance grievance = fetchByUuid_C_First(
	...
	public Grievance fetchByUuid_C_First(
		...
		List<Grievance> list = findByUuid_C(
	...
	public Grievance findByUuid_C_Last(
		...
		Grievance grievance = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public Grievance[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, grievance, uuid, companyId, orderByComparator, true);

			array[1] = grievance;

			array[2] = getByUuid_C_PrevAndNext(
				session, grievance, uuid, companyId, orderByComparator, false);
	...
	protected Grievance getByUuid_C_PrevAndNext(
		Session session, Grievance grievance, String uuid, long companyId,
		OrderByComparator<Grievance> orderByComparator, boolean previous) {
	...
	public void cacheResult(Grievance grievance) {
		...
		finderCache.putResult(
			...
			new Object[] {grievance.getUuid(), grievance.getGroupId()},
			grievance);
	}
	...
	protected void cacheUniqueFindersCache(
		GrievanceModelImpl grievanceModelImpl) {

		Object[] args = new Object[] {
			grievanceModelImpl.getUuid(), grievanceModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, grievanceModelImpl);
	}
	...
	public Grievance create(long grievanceId) {
		...
		grievance.setUuid(uuid);

		grievance.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public Grievance updateImpl(Grievance grievance) {
		...
		if (Validator.isNull(grievance.getUuid())) {
			String uuid = _portalUUID.generate();
		...
		cacheUniqueFindersCache(grievanceModelImpl);
	...
	public void activate() {
		...
		_setGrievanceUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setGrievanceUtilPersistence(null);

		entityCache.removeCache(GrievanceImpl.class.getName());
	}

	private void _setGrievanceUtilPersistence(
		GrievancePersistence grievancePersistence) {

		try {
			Field field = GrievanceUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, grievancePersistence);
		}
	...
	@Reference
	private GrievanceModelArgumentsResolver _grievanceModelArgumentsResolver;
