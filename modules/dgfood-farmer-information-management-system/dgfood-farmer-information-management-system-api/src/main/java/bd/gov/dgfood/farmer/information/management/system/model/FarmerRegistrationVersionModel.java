...
/**
 * The base model interface for the FarmerRegistrationVersion service. Represents a row in the &quot;DGFood_FarmerRegistrationVer&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>bd.gov.dgfood.farmer.information.management.system.model.impl.FarmerRegistrationVersionModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>bd.gov.dgfood.farmer.information.management.system.model.impl.FarmerRegistrationVersionImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface FarmerRegistrationVersionModel
	extends BaseModel<FarmerRegistrationVersion>, ShardedModel, StagedModel,
			WorkflowedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a farmer registration version model instance should use the {@link FarmerRegistrationVersion} interface instead.
	 */
