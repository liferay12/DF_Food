...
/**
 * Provides the local service interface for FarmerRegistrationVersion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FarmerRegistrationVersionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FarmerRegistrationVersionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.farmer.information.management.system.service.impl.FarmerRegistrationVersionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the farmer registration version local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FarmerRegistrationVersionLocalServiceUtil} if injection and service tracking are not available.
	 */
