...
public abstract class BaseCaptchaAnswerResourceImpl
	implements CaptchaAnswerResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/dgfood-headless-common-delivery/v1.0/captcha/get-answer'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "CaptchaAnswer")
		}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/captcha/get-answer")
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseCaptchaAnswerResourceImpl.class);
