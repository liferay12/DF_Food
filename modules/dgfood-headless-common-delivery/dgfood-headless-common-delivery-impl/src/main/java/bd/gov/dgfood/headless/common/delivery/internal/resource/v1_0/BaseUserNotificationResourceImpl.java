...
public abstract class BaseUserNotificationResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/dgfood-headless-common-delivery/v1.0/user-notifications/{userNotificationUserId}'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/user-notifications/{userNotificationUserId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<UserNotification> getUserNotificationsPage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("userNotificationUserId")
			Long userNotificationUserId,
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/dgfood-headless-common-delivery/v1.0/user-notifications/{userNotificationUserId}/mark-as-read'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	...
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void postUserNotificationsMarkAsRead(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("userNotificationUserId")
			Long userNotificationUserId,
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/dgfood-headless-common-delivery/v1.0/user-notifications/{userNotificationUserId}/un-read-count'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	...
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public UserNotification getUserNotificationsUnReadCount(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("userNotificationUserId")
			Long userNotificationUserId)
	...
	public Page<UserNotification> read(
		...
		return getUserNotificationsPage(
			Long.parseLong((String)parameters.get("userNotificationUserId")),
			pagination);
	}
