 ...
 * @generated
 */
@Component(immediate = true, service = UserNotificationResource.Factory.class)
@Generated("")
public class UserNotificationResourceFactoryImpl
	implements UserNotificationResource.Factory {

	@Override
	public UserNotificationResource.Builder create() {
		return new UserNotificationResource.Builder() {
			...
			@Override
			public UserNotificationResource.Builder checkPermissions(
			...
			@Override
			public UserNotificationResource.Builder httpServletRequest(
			...
			@Override
			public UserNotificationResource.Builder httpServletResponse(
			...
			@Override
			public UserNotificationResource.Builder preferredLocale(
			...
			@Override
			public UserNotificationResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		UserNotificationResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		UserNotificationResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, UserNotificationResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			UserNotificationResource.class.getClassLoader(),
			UserNotificationResource.class);

		try {
			Constructor<UserNotificationResource> constructor =
				(Constructor<UserNotificationResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(userNotificationResource);
