...
public abstract class BaseUserAuthenticationRequestResourceImpl
	implements UserAuthenticationRequestResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/dgfood-headless-user-authentication/v1.0/authenticate-user' -d $'{"authType": ___, "password": ___, "userName": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	...
	@Override
	public UserAuthenticationResponseData authenticateUser(
			UserAuthenticationRequestData userAuthenticationRequestData)
		throws Exception {

		return new UserAuthenticationResponseData();
	}
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseUserAuthenticationRequestResourceImpl.class);
