...
@GraphQLName(
	...
	value = "UpdateFGLicenseApplication"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "UpdateFGLicenseApplication")
public class UpdateFGLicenseApplication implements Serializable {

	public static UpdateFGLicenseApplication toDTO(String json) {
		return ObjectMapperUtil.readValue(
			UpdateFGLicenseApplication.class, json);
	}

	public static UpdateFGLicenseApplication unsafeToDTO(String json) {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof UpdateFGLicenseApplication)) {
			return false;
		}

		UpdateFGLicenseApplication updateFGLicenseApplication =
			(UpdateFGLicenseApplication)object;

		return Objects.equals(
			toString(), updateFGLicenseApplication.toString());
	}
	...
	@Schema(
		...
		defaultValue = "dgfood.headless.license.management.system.dto.v1_0.UpdateFGLicenseApplication",
		name = "x-class-name"
	)
