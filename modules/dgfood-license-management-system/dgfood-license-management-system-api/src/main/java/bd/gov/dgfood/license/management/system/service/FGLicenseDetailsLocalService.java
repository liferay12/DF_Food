...
/**
 * Provides the local service interface for FGLicenseDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FGLicenseDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FGLicenseDetailsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.license.management.system.service.impl.FGLicenseDetailsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fg license details local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FGLicenseDetailsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FGLicenseDetails addFGLicenseDetails(
	...
	public FGLicenseDetails addFGLicenseDetails(
		...
		String tradeLicenseNumber, Date tradeLicenseExpiryDate,
		...
		long taxIdentfctDocId, long bankStatementDocId, String applicationType);
	...
	public FGLicenseDetails createFGLicenseDetails(long fgLicenseMasterId);
	...
	public FGLicenseDetails deleteFGLicenseDetails(
		FGLicenseDetails fgLicenseDetails);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FGLicenseDetails deleteFGLicenseDetails(long fgLicenseMasterId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FGLicenseDetails fetchFGLicenseDetails(long fgLicenseMasterId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FGLicenseDetails getFGLicenseDetails(long fgLicenseMasterId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FGLicenseDetails> getFGLicenseDetailses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FGLicenseDetails updateFGLicenseDetails(
		FGLicenseDetails fgLicenseDetails);
