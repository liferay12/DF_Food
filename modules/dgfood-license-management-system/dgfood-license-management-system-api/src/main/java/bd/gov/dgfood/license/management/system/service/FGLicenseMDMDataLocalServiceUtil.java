...
/**
 * Provides the local service utility for FGLicenseMDMData. This utility wraps
 * <code>bd.gov.dgfood.license.management.system.service.impl.FGLicenseMDMDataLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FGLicenseMDMDataLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.license.management.system.service.impl.FGLicenseMDMDataLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FGLicenseMDMData addFGLicenseMDMData(
		FGLicenseMDMData fgLicenseMDMData) {

		return getService().addFGLicenseMDMData(fgLicenseMDMData);
	}
	 ...
	 */
	public static FGLicenseMDMData createFGLicenseMDMData(long fgLicenseMDMId) {
		return getService().createFGLicenseMDMData(fgLicenseMDMId);
	}
	 ...
	 */
	public static FGLicenseMDMData deleteFGLicenseMDMData(
		FGLicenseMDMData fgLicenseMDMData) {

		return getService().deleteFGLicenseMDMData(fgLicenseMDMData);
	}
	 ...
	 */
	public static FGLicenseMDMData deleteFGLicenseMDMData(long fgLicenseMDMId)
		throws PortalException {

		return getService().deleteFGLicenseMDMData(fgLicenseMDMId);
	}
	...
	public static FGLicenseMDMData fetchFGLicenseMDMData(long fgLicenseMDMId) {
		return getService().fetchFGLicenseMDMData(fgLicenseMDMId);
	}
	 ...
	 * @throws PortalException if a fg license mdm data with the primary key could not be found
	 */
	public static FGLicenseMDMData getFGLicenseMDMData(long fgLicenseMDMId)
		throws PortalException {

		return getService().getFGLicenseMDMData(fgLicenseMDMId);
	}
	 ...
	 */
	public static List<FGLicenseMDMData> getFGLicenseMDMDatas(
		int start, int end) {

		return getService().getFGLicenseMDMDatas(start, end);
	}
	 ...
	 */
	public static int getFGLicenseMDMDatasCount() {
		return getService().getFGLicenseMDMDatasCount();
	}
	 ...
	 */
	public static FGLicenseMDMData updateFGLicenseMDMData(
		FGLicenseMDMData fgLicenseMDMData) {

		return getService().updateFGLicenseMDMData(fgLicenseMDMData);
	}

	public static FGLicenseMDMDataLocalService getService() {
		return _service;
	}

	private static volatile FGLicenseMDMDataLocalService _service;
