...
%>
<h3>
	<liferay-ui:message key="duplicate-milling-license-label"></liferay-ui:message>
</h3>
...
<div class="row">
	...
	<div class="col-6">
		<label for="reasonOfDuplicateLicense"><liferay-ui:message
				key="reasonOfDuplicateLicense-label"></liferay-ui:message><span class="txt-red">*</span></label>
		<aui:select id="reasonOfDuplicateLicense" name="reasonOfDuplicateLicense"
			label="" cssClass="validate" value="">
			<aui:validator name="required" errorMessage="reasonOfDuplicateLicense-error-label" />
...
<aui:button-row>
	...
	<aui:button id="submitDetails" value='submit-request'
		onClick="validateFields('duplicate_info');"></aui:button>
</aui:button-row>
<script>
