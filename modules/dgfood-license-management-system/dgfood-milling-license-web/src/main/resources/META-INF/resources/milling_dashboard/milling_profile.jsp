...
<portlet:renderURL var="updateFormDataURL">
	<portlet:param name="mvcRenderCommandName"
		value="<%=MillingLicensePortletKeys.UPDATE_MILLING_MVC_RENDER_COMMAND%>" />
...
<aui:button-row>
	<aui:button type="button" value='edit' href="<%=updateFormDataURL%>"></aui:button>
</aui:button-row>