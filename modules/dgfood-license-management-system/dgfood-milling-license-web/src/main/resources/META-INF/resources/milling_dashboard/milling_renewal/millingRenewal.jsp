...
%>
<portlet:actionURL var="submitRenewalFormDataURL"
	name="<%=MillingLicensePortletKeys.SUBMIT_RENEWAL_MILLING_MVC_ACTION_COMMAND%>">
...
<aui:form name="form" action="<%=submitRenewalFormDataURL%>" method="post"
	enctype="multipart/form-data">

	<input type="hidden" id="portletNamespace" value="<portlet:namespace/>" />
	<div class="application_step"
		id='<portlet:namespace/>renewal_info'>
		<liferay-util:include page="/milling_dashboard/milling_renewal/renewal-steps/renewal_info.jsp"
