...
/**
 * Provides the local service utility for MovementContractor. This utility wraps
 * <code>bd.gov.dgfood.movement.contractor.service.impl.MovementContractorLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MovementContractorLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.movement.contractor.service.impl.MovementContractorLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MovementContractor addMovementContractor(
		MovementContractor movementContractor) {

		return getService().addMovementContractor(movementContractor);
	}
	 ...
	 */
	public static MovementContractor createMovementContractor(
		long movementContractorId) {

		return getService().createMovementContractor(movementContractorId);
	}
	 ...
	 */
	public static MovementContractor deleteMovementContractor(
			long movementContractorId)
		throws PortalException {

		return getService().deleteMovementContractor(movementContractorId);
	}
	...
	public static MovementContractor deleteMovementContractor(
		...
		return getService().deleteMovementContractor(movementContractor);
	}
	...
	public static MovementContractor fetchMovementContractor(
		long movementContractorId) {

		return getService().fetchMovementContractor(movementContractorId);
	}
	 ...
	 */
	public static MovementContractor fetchMovementContractorByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchMovementContractorByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a movement contractor with the primary key could not be found
	 */
	public static MovementContractor getMovementContractor(
			long movementContractorId)
		throws PortalException {

		return getService().getMovementContractor(movementContractorId);
	}
	 ...
	 */
	public static MovementContractor getMovementContractorByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getMovementContractorByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<MovementContractor> getMovementContractors(
		int start, int end) {

		return getService().getMovementContractors(start, end);
	}
	 ...
	 */
	public static List<MovementContractor>
		getMovementContractorsByUuidAndCompanyId(String uuid, long companyId) {

		return getService().getMovementContractorsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getMovementContractorsCount() {
		return getService().getMovementContractorsCount();
	}
	 ...
	 */
	public static MovementContractor updateMovementContractor(
		MovementContractor movementContractor) {

		return getService().updateMovementContractor(movementContractor);
	}

	public static MovementContractorLocalService getService() {
		return _service;
	}

	private static volatile MovementContractorLocalService _service;
