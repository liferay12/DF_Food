...
/**
 * Provides the local service interface for SubProgram. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SubProgramLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SubProgramLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.movement.contractor.service.impl.SubProgramLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sub program local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SubProgramLocalServiceUtil} if injection and service tracking are not available.
	 */
