...
@Meta.OCD(id = "bd.gov.dgfood.configuration.FIMSWheatSeasonConfiguration", name = "fims-season-configuration-wheat")
public interface FIMSWheatSeasonConfiguration {
